...
# ── Database: uses PostgreSQL on Railway (set DATABASE_URL env var), falls back to SQLite locally
_db_url = os.environ.get('DATABASE_URL', 'sqlite:///volunteeros.db')
...
# ── JWT secret: read from env var so it's not hardcoded in source
app.config['JWT_SECRET_KEY'] = os.environ.get('JWT_SECRET_KEY', 'vos-secret-2025-change-me')
...
# ══════════════════════════════════════════════════════════════════════════════
# STARTUP — runs under both  `python app.py`  AND  gunicorn (Railway)
# ══════════════════════════════════════════════════════════════════════════════
...
if __name__ == '__main__':
    ...
    print(f"\n🚀 VolunteerOS running at → http://localhost:{port}\n")
